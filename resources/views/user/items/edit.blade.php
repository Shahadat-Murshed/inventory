...
@section('content')
    ...
    <h2 class="mt-5">Editing {{ $item->name }}</h2>
    <form class="col-md-12" method="POST" action="{{ route('user.items.update', $item->id) }}" enctype="multipart/form-data">
        @method('PUT')
        @csrf
        <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <select name="inventory_id" class="form-control" id="exampleFormControlSelect1">
                                ...
                                @foreach ($inventories as $inventory)
                                    <option {{ $item->inventory_id == $inventory->id ? 'selected' : '' }} value={{ $inventory->id }}>
                                        {{ $inventory->name }}
                                    </option>
                                @endforeach
                            </select>
                ...
                <div class="col-12">
                    <div class="card p-5">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="description" rows="5" name="description" placeholder="Write a short Description (optional).">{{ $item->description }}</textarea>
                        </div>
                ...
                <div class="card p-5 h-100">
                    ...
                    <div class="row">
                        <div class="col-md-12 d-flex justify-content-center" id="preview">
                            <img src="{{ $item->image }}" alt="Admin Avatar" height="600px" width="auto">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12 d-flex justify-content-center" id="preview">
